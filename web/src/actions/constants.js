...
export const EXPO_VIEWER_AUDIO_FILES_TOTAL = "EXPO_VIEWER_AUDIO_FILES_TOTAL";
export const EXPO_VIEWER_AUDIO_FILE_LOADED = "EXPO_VIEWER_AUDIO_FILE_LOADED";
export const EXPO_VIEWER_VIDEO_FILES_TOTAL = "EXPO_VIEWER_VIDEO_FILES_TOTAL";
export const EXPO_VIEWER_VIDEO_FILE_LOADED = "EXPO_VIEWER_VIDEO_FILE_LOADED";
export const EXPO_VIEWER_FILE_ERROR_ADD = "EXPO_VIEWER_FILE_ERROR_ADD";
export const EXPO_VIEWER_FILE_ERROR_TIMEOUT_ADD =

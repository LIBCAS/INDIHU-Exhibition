        ...
        <div className="flex-header-row">
          <SelectField
            ...
            menuItems={[
              ...
              { label: t("usersToAcceptLabel"), value: "FOR_ACCEPT" },
            ]}
            itemLabel="label"
            itemValue="value"
            position="below"
            value={tableState.tableType}
            onChange={(newTableType: UserTableStateObj["tableType"]) => {
              setTableState("tableType", newTableType);
            }}
          />

          {tableState.tableType === "ALL" && (
            <SelectField
